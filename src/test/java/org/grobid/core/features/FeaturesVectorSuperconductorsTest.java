...
public class FeaturesVectorSuperconductorsTest {
    ...
    public void printVector() {
        ...
        assertThat(features.printVector(), is("token1 token1 t to tok toke 1 n1 en1 ken1 NOCAPS CONTAINDIGIT 0 NOPUNCT tokenX xxxd xd SAMEFONT SAMEFONTSIZE true false SUPERSCRIPT NONE <other> bao"));
    }
}