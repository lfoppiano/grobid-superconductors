...
import org.grobid.core.features.FeaturesVectorNanostructure;
...
//NOT Usable at the moment as the features files are not generated

public class NanostructureTrainer extends AbstractTrainer {
    ...
    public NanostructureTrainer() {
        super(SuperconductorsModels.NANOSTRUCTURE);
        ...
        try {
            ...
            for (int n = 0; n < refFiles.size(); n++) {
                ...
                AnnotationValuesTEIStaxHandler handler = new AnnotationValuesTEIStaxHandler(TOP_LEVEL_ANNOTATION_DEFAULT_PATHS,
                    Arrays.asList("material", "property", "value", "unit"), new Language("ja"));
                ...
                for (List<Pair<String, String>> paragraph : xmlFile) {
                    ...
                    for (Pair<String, String> token : paragraph) {
                        ...
                        TaggingLabel taggingLabel = TaggingLabels.labelFor(SuperconductorsModels.NANOSTRUCTURE, label);
                        FeaturesVectorNanostructure featuresVectorSuperconductors = FeaturesVectorNanostructure.addFeatures(new LayoutToken(value, taggingLabel), label, "false");
    ...
    public static void main(String[] args) {
        ...
        Trainer trainer = new NanostructureTrainer();
