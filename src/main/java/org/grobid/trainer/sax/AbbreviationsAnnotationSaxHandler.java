 ...
 */
public class AbbreviationsAnnotationSaxHandler extends DefaultHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbbreviationsAnnotationSaxHandler.class);

    private StringBuffer accumulator = new StringBuffer(); // Accumulate parsed text

    private boolean ignore = false;
    private boolean openAbbreviation = false;
    private String currentTag = null;

    private List<Pair<String, String>> labeled = null; // store line by line the labeled data

    public AbbreviationsAnnotationSaxHandler() {
    }
    ...
    public void startElement(String namespaceURI,
        ...
        try {
            if (qName.equals("lb")) {
                ...
                if (qName.equals("acronym") && !ignore) {
                    openAbbreviation = true;
                    currentTag = "<acronym>";
                } else if (qName.equals("figure")) {
