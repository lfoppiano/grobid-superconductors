...
public class NanostructureNoFeaturesTrainer extends AbstractTrainer {
    ...
    public NanostructureNoFeaturesTrainer() {
    ...
    public static void main(String[] args) {
        ...
        Trainer trainer = new NanostructureNoFeaturesTrainer();
