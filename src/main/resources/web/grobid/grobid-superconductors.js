...
var grobid = (function ($) {
    ...
    function annotateEntity(thePos, theUrl, page_height, page_width, index) {
        var page = thePos.p;
        ...
        $('#annot-' + index).bind('hover', viewQuantityPDF);
        $('#annot-' + index).bind('click', viewQuantityPDF);
    }
    ...
    function viewSuperconductor() {
        ...
        string = toHtml(superconductor, -1);
    ...
    function viewQuantityPDF() {
        ...
        var string = toHtml(superconMap[localMeasurementNumber], $(this).position().top);

        $('#detailed_annot-' + pageIndex).html(string);
        $('#detailed_annot-' + pageIndex).show();
    }

    function toHtml(superconductor, topPos) {
        var string = "";
        var first = true;
